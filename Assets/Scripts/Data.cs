...
namespace DungeonDefence
{
	...
	public static class Data
	{
		...
		{
			townhall, goldmine, goldstorage , elixirmine, elixirstorage, darkelixirmine, darkelixirstorage, buildershut, barracks, armycamp
		}
		public class Player
		{
			public int gold = 0;
	...
	public static BuildingCount GetTownhallLimits(int townHallLevel)
		{
